...
import dev.springboot.service.ContactService;
...
public class HomeController {
    ...
    @PutMapping("/edit/{id}")
    public void editContact(@RequestBody Contact contact, @PathVariable long id){
    ...
    public void downloadTemplate() throws IOException {
        ...
        Sheet sheet = workbook.createSheet("template_import_contact");
